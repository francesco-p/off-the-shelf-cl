...
def get_opt():
    ...
    parser.add_argument('--model', type=str, default='vit_base_patch16_224', help='select the models')
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='select the batch_size')
